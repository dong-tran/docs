# TÓM TẮT SÁCH TOÁN 7 - TẬP HAI
### (Bộ sách "Kết nối tri thức với cuộc sống")

## Mục lục

- [Chương VI. Tỉ lệ thức và đại lượng tỉ lệ](#chương-vi-tỉ-lệ-thức-và-đại-lượng-tỉ-lệ)
- [Chương VII. Biểu thức đại số và đa thức một biến](#chương-vii-biểu-thức-đại-số-và-đa-thức-một-biến)
- [Chương VIII. Làm quen với biến cố và xác suất của biến cố](#chương-viii-làm-quen-với-biến-cố-và-xác-suất-của-biến-cố)
- [Chương IX. Quan hệ giữa các yếu tố trong một tam giác](#chương-ix-quan-hệ-giữa-các-yếu-tố-trong-một-tam-giác)
...
**Đa thức một biến x:** tổng của những đơn thức chỉ chứa một biến x.
> Ví dụ: P(x) = 3x³ − 2x² + x − 5
...
**Biến cố:** một sự kiện có thể xảy ra hoặc không xảy ra khi thực hiện một hành động, phép thử, thí nghiệm.

**Ba loại biến cố:**
- **Biến cố chắc chắn:** luôn xảy ra. Ví dụ: "mặt trời mọc ở hướng Đông".
- **Biến cố không thể:** không bao giờ xảy ra. Ví dụ: "tung xúc xắc 6 mặt, ra mặt số 7".
- **Biến cố ngẫu nhiên:** có thể xảy ra hoặc không, không thể biết chắc trước. Ví dụ: "tung đồng xu, ra mặt sấp".

> Ví dụ minh hoạ: trong hộp có 3 bi đỏ, 2 bi xanh. Lấy ngẫu nhiên 1 bi:
> - "Lấy được bi đỏ hoặc xanh" → biến cố chắc chắn (vì hộp chỉ có 2 màu này).
> - "Lấy được bi vàng" → biến cố không thể.
> - "Lấy được bi đỏ" → biến cố ngẫu nhiên.

---

## Bài 30. Làm quen với xác suất của biến cố

**Xác suất của biến cố:** con số thể hiện **khả năng xảy ra** của biến cố đó, luôn nằm trong khoảng từ 0 đến 1.

- Biến cố **không thể** có xác suất **bằng 0**.
- Biến cố **chắc chắn** có xác suất **bằng 1**.
- Biến cố **ngẫu nhiên** có xác suất nằm **giữa 0 và 1**.
...
**Định lí:** Trong một tam giác, **góc đối diện với cạnh lớn hơn thì lớn hơn** (và ngược lại: cạnh đối diện với góc lớn hơn thì lớn hơn).

> Ví dụ: tam giác ABC có AB = 5 cm, AC = 7 cm, BC = 8 cm (BC lớn nhất) → góc đối diện BC là góc A → góc A là góc lớn nhất trong tam giác.

*(Ứng dụng: từ độ dài 3 cạnh có thể suy ra ngay góc nào lớn nhất/nhỏ nhất mà không cần đo góc trực tiếp.)*

---

## Bài 32. Quan hệ giữa đường vuông góc và đường xiên

Từ một điểm A ở ngoài đường thẳng d, kẻ đường vuông góc AH (H∈d) và các đường xiên AB (B∈d, B≠H).

- **AH gọi là đường vuông góc**, AB gọi là **đường xiên**, HB gọi là **hình chiếu** của đường xiên AB trên d.

**Định lí (so sánh đường vuông góc và đường xiên):**
> Trong các đường xiên và đường vuông góc kẻ từ một điểm đến một đường thẳng, **đường vuông góc là đường ngắn nhất**.

**Định lí (so sánh hai đường xiên qua hình chiếu):**
> Trong hai đường xiên, đường xiên nào có **hình chiếu lớn hơn** thì **lớn hơn** (và ngược lại).

> Minh hoạ thực tế: khoảng cách ngắn nhất từ một điểm đến một con đường thẳng chính là đoạn vuông góc — đây là lí do khi "đi tắt" đến đường, người ta luôn chọn đường vuông góc để đi ngắn nhất.
...
**Đường trung trực của một cạnh:** đường vuông góc với cạnh đó tại trung điểm.
**Tính chất:** Ba đường trung trực của tam giác cùng đi qua một điểm, gọi là **tâm đường tròn ngoại tiếp** tam giác (điểm này cách đều 3 đỉnh).

**Đường cao của tam giác:** đoạn thẳng từ một đỉnh vuông góc với cạnh đối diện (hoặc đường thẳng chứa cạnh đó).
**Tính chất:** Ba đường cao của tam giác cùng đi qua một điểm, gọi là **trực tâm** của tam giác.

**Bảng tổng hợp 4 đường đặc biệt và điểm đồng quy (rất hay nhầm lẫn, nên nhớ kĩ):**
...
**Hình lăng trụ đứng:** có 2 đáy là hai đa giác bằng nhau và song song, các mặt bên là các **hình chữ nhật vuông góc với đáy**.
