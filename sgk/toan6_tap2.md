# TÓM TẮT SÁCH TOÁN 6 - TẬP HAI
### (Bộ sách "Kết nối tri thức với cuộc sống")

## Mục lục

- [Chương VI. Phân số](#chương-vi-phân-số)
- [Chương VII. Số thập phân](#chương-vii-số-thập-phân)
- [Chương VIII. Những hình học cơ bản](#chương-viii-những-hình-học-cơ-bản)
- [Chương IX. Dữ liệu và xác suất thực nghiệm](#chương-ix-dữ-liệu-và-xác-suất-thực-nghiệm)
...
### Luyện tập chung (sau Bài 24)
Ôn quy đồng mẫu số, so sánh phân số, đổi qua lại giữa phân số và hỗn số.
...
**Quy tắc làm tròn số:** để làm tròn một số thập phân đến một hàng nào đó, ta nhìn chữ số ngay sau hàng cần làm tròn:
...
- **Điểm** là hình học đơn giản nhất, không có kích thước, thường kí hiệu bằng chữ cái in hoa: A, B, C...
- **Đường thẳng** không bị giới hạn về hai phía, kí hiệu bằng chữ cái thường: a, b, xy...
- **Ba điểm thẳng hàng:** ba điểm cùng nằm trên một đường thẳng. Ngược lại, gọi là **ba điểm không thẳng hàng**.
- **Hai đường thẳng phân biệt:** hoặc **cắt nhau** (có đúng 1 điểm chung), hoặc **song song** (không có điểm chung nào).
- **Tiên đề:** Có một và chỉ một đường thẳng đi qua hai điểm phân biệt cho trước.

**Minh hoạ:** giống như căng một sợi dây thẳng giữa hai chiếc đinh trên tường — chỉ có đúng một cách căng thẳng duy nhất, đó chính là hình ảnh của đường thẳng đi qua hai điểm.

---

## Bài 33. Điểm nằm giữa hai điểm. Tia

- Với ba điểm A, M, B thẳng hàng: nếu M nằm giữa A và B, ta nói M là điểm nằm giữa.
- **Tia gốc O:** là một phần của đường thẳng bị giới hạn bởi điểm O về một phía, kéo dài mãi về phía còn lại. O gọi là **gốc của tia**.
- Hai tia chung gốc và tạo thành một đường thẳng gọi là **hai tia đối nhau**.
- Hai tia trùng nhau: chung gốc và có cùng một điểm khác (ngoài gốc) nằm trên cả hai tia.

**Minh hoạ:** tia sáng đèn pin phát ra từ một điểm (gốc) đi thẳng mãi về một hướng — đó là hình ảnh trực quan của tia trong toán học.
...
### Luyện tập chung (sau Bài 35)
Ôn về điểm, đường thẳng, tia, đoạn thẳng, trung điểm — kĩ năng vẽ hình và tính độ dài đoạn thẳng.
...
- Dùng **thước đo góc** để đo góc, đơn vị là **độ** (kí hiệu °).
- Mỗi góc có một số đo xác định, không vượt quá 180°.
...
- **Dữ liệu (số liệu):** các thông tin thu thập được về một vấn đề, đối tượng nào đó, có thể là **số** (dữ liệu số) hoặc **không phải số** (dữ liệu không phải số, ví dụ: tên, màu sắc, sở thích).
- **Thu thập dữ liệu:** thông qua quan sát, lập phiếu hỏi (khảo sát), tìm trong sách báo, internet...
- **Tính hợp lí của dữ liệu:** dữ liệu cần được kiểm tra xem có phù hợp với thực tế hay không (không quá lớn/nhỏ bất thường, không mâu thuẫn).

> Ví dụ: khảo sát môn thể thao yêu thích của các bạn trong lớp bằng phiếu hỏi, rồi ghi lại thành danh sách — đó là quá trình thu thập dữ liệu.

---

## Bài 39. Bảng thống kê và biểu đồ tranh

- **Bảng thống kê:** trình bày dữ liệu dưới dạng hàng và cột, giúp so sánh, đối chiếu dễ dàng.
- **Biểu đồ tranh:** dùng hình ảnh (biểu tượng) để biểu diễn số liệu, mỗi hình ảnh tượng trưng cho một số lượng nhất định (có ghi chú kèm theo).

> Ví dụ minh hoạ: biểu đồ tranh về số cây được trồng trong tuần, mỗi hình 🌳 tượng trưng cho 5 cây:
> Thứ Hai: 🌳🌳🌳 (tức 15 cây), Thứ Ba: 🌳🌳 (tức 10 cây)...

---

## Bài 40. Biểu đồ cột

- **Biểu đồ cột:** biểu diễn dữ liệu bằng các cột hình chữ nhật, chiều cao (hoặc chiều dài) cột tỉ lệ với số liệu.
- Trục ngang thường ghi các đối tượng (thời gian, loại...), trục đứng ghi giá trị số liệu.
- Giúp **so sánh trực quan** số liệu giữa các đối tượng khác nhau.

> Ví dụ: biểu đồ cột thể hiện số học sinh giỏi của 4 lớp 6A, 6B, 6C, 6D — cột nào cao hơn thể hiện lớp có nhiều học sinh giỏi hơn.

---

## Bài 41. Biểu đồ cột kép

- **Biểu đồ cột kép:** mỗi vị trí trên trục ngang có **hai cột đặt cạnh nhau** (thường khác màu), dùng để **so sánh hai bộ dữ liệu** cùng lúc.

> Ví dụ: biểu đồ cột kép so sánh số học sinh nam và nữ của từng lớp — mỗi lớp có 2 cột (một cột nam, một cột nữ) đặt sát nhau để dễ đối chiếu.

---

### Luyện tập chung (sau Bài 41)
Ôn cách đọc, vẽ và phân tích bảng thống kê, biểu đồ tranh, biểu đồ cột, biểu đồ cột kép.

---

## Bài 42. Kết quả có thể và sự kiện trong trò chơi, thí nghiệm

- **Kết quả có thể:** các khả năng có thể xảy ra khi thực hiện một trò chơi hoặc thí nghiệm.
- **Sự kiện:** một tập hợp gồm một hoặc nhiều kết quả có thể, gắn với một điều kiện cho trước.

> Ví dụ: tung một con xúc xắc 6 mặt — có 6 kết quả có thể (1,2,3,4,5,6). "Sự kiện xuất hiện mặt chẵn" gồm các kết quả {2; 4; 6}.

---

## Bài 43. Xác suất thực nghiệm

**Khái niệm:** Xác suất thực nghiệm của một sự kiện là **tỉ số giữa số lần sự kiện xảy ra và tổng số lần thực hiện thí nghiệm (trò chơi)**.
...
Ôn thu thập và biểu diễn dữ liệu (bảng, biểu đồ tranh, biểu đồ cột, cột kép), khái niệm kết quả có thể - sự kiện, tính xác suất thực nghiệm qua các trò chơi (tung đồng xu, tung xúc xắc, bốc thăm...).

---

## Hoạt động thực hành trải nghiệm & Ôn tập cuối năm (cuối sách)
- **Kế hoạch chi tiêu cá nhân và gia đình:** vận dụng phân số, số thập phân, tỉ số phần trăm để lập kế hoạch thu - chi thực tế.
