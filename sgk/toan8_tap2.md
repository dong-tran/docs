# TÓM TẮT SÁCH TOÁN 8 - TẬP HAI
### (Bộ sách "Kết nối tri thức với cuộc sống")

## Mục lục

- [Chương VI. Phân thức đại số](#chương-vi-phân-thức-đại-số)
- [Chương VII. Phương trình bậc nhất và hàm số bậc nhất](#chương-vii-phương-trình-bậc-nhất-và-hàm-số-bậc-nhất)
- [Chương VIII. Mở đầu về tính xác suất của biến cố](#chương-viii-mở-đầu-về-tính-xác-suất-của-biến-cố)
- [Chương IX. Tam giác đồng dạng](#chương-ix-tam-giác-đồng-dạng)
...
**Các bước giải:**
1. Chọn ẩn số và đặt điều kiện thích hợp.
2. Biểu diễn các đại lượng chưa biết khác theo ẩn.
3. Lập phương trình dựa vào mối quan hệ trong đề bài.
4. Giải phương trình.
...
- **Kết quả có thể:** tất cả các khả năng có thể xảy ra khi thực hiện một phép thử (trò chơi, thí nghiệm ngẫu nhiên).
- **Kết quả thuận lợi cho một biến cố:** những kết quả có thể làm cho biến cố đó **xảy ra**.

> Ví dụ: tung 1 xúc xắc 6 mặt, biến cố A = "xuất hiện mặt có số chấm là số nguyên tố" → các kết quả thuận lợi cho A là {2; 3; 5} (3 kết quả).
...
**Nhắc lại xác suất thực nghiệm** (đã học ở lớp 6): tỉ số giữa số lần biến cố xảy ra và tổng số lần thử nghiệm thực tế.
...
**Định lí:** đường thẳng song song với một cạnh của tam giác và cắt hai cạnh còn lại sẽ tạo ra tam giác mới đồng dạng với tam giác đã cho (liên hệ với định lí Thalès đã học).
...
|---|---|
| **Cạnh - Cạnh - Cạnh (c.c.c)** | Ba cặp cạnh tương ứng tỉ lệ |
| **Cạnh - Góc - Cạnh (c.g.c)** | Hai cặp cạnh tương ứng tỉ lệ và góc xen giữa bằng nhau |
...
**Ứng dụng thực tế:** tính khoảng cách chéo, chiều cao, độ dốc — ví dụ tính chiều dài thang dựa vào chiều cao tường và khoảng cách chân thang tới tường.

---

## Bài 36. Các trường hợp đồng dạng của hai tam giác vuông

Vì tam giác vuông đã có sẵn 1 góc vuông bằng nhau, nên các trường hợp đồng dạng được rút gọn:

1. **Hai cạnh góc vuông tỉ lệ** → hai tam giác vuông đồng dạng (c.g.c thu gọn).
2. **Một góc nhọn bằng nhau** → hai tam giác vuông đồng dạng (g.g thu gọn).
3. **Cạnh huyền và một cạnh góc vuông tỉ lệ** → hai tam giác vuông đồng dạng (trường hợp đặc biệt, dùng định lí Pythagore để suy ra cạnh còn lại cũng tỉ lệ).

---

## Bài 37. Hình đồng dạng

**Khái niệm mở rộng:** không chỉ tam giác, hai hình bất kì (đa giác, hình phức tạp...) được gọi là **đồng dạng** nếu hình này là ảnh phóng to/thu nhỏ theo cùng một tỉ lệ của hình kia (giữ nguyên hình dạng).

> Ví dụ thực tế: bản đồ và địa hình thực tế; ảnh chụp và ảnh phóng to; các mô hình thu nhỏ (mô hình xe, mô hình kiến trúc) đều là hình đồng dạng với vật thật theo một tỉ lệ nhất định.
...
**Cấu tạo:** có đáy là **tam giác đều**, các mặt bên là các **tam giác cân bằng nhau** chung đỉnh (gọi là đỉnh của hình chóp).
...
**So sánh nhanh hai loại hình chóp đều:**

| | Hình chóp tam giác đều | Hình chóp tứ giác đều |
|---|---|---|
| Đáy | Tam giác đều | Hình vuông |
| Số mặt bên | 3 | 4 |
| Số cạnh bên | 3 | 4 |
